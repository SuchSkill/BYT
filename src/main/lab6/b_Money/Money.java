...
public class Money implements Comparable {
	...
	public String toString() {
		String currName = currency.getName();
		Double amountDouble = amount/100.0;
		return amountDouble + " " + currName;
	}
	...
	public boolean equals(Money other) {
		...
		return currency != null ? currency.equals(other.currency) : other.currency == null;
	}
	...
	public Money add(Money other) {
		amount += currency.valueInThisCurrency(other.amount, other.getCurrency());;
		return this;
	...
	public int compareTo(Object other) {
		...
		if (other == null || getClass() != other.getClass()) throw new IllegalArgumentException();
